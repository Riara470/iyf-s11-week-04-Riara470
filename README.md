# IYF S11 - Week 04: JavaScript Fundamentals
...
- **Array Methods**: Transform and filter data using `.map()`, `.filter()`, `.find()`, `.reduce()`
- **Objects**: Create, access, update, and iterate over object properties
- **Problem Solving**: Build a complete calculator that handles edge cases like division by zero
- **node**:learned how to run my work on node to see the output and rectified the mistakes
